...
<div class="row">
    ...
    <div class="col-xl-6">
        <div class="form-group">
           <label class="small mb-1" for="title">Available - Title</label>
        ...
        <div class="form-group">
           <label class="small mb-1" for="id_number">ID / Passport Number</label>
        ...
        <div class="form-group">
           <label class="small mb-1" for="passport_number">Tax Number</label>
        ...
        <div class="form-group">
            <label class="small mb-1" for="gender">Source of Funds</label>
        ...
        <div class="form-group">
           <label class="small mb-1" for="marital_status">Alive / Deceased Status</label>
        ...
        <div class="form-group">
           <label class="small mb-1" for="marital_status">Membership Category</label>
        ...
        <div class="form-group">
           <label class="small mb-1" for="marital_status">Membership / Policy Status</label>
        ...
        <div class="form-group">
           <label class="small mb-1" for="gender">Membership Type</label>
   ...
   <div class="col-xl-6">
    ...
    <div class="form-group">
       <label class="small mb-1" for="address_line3">Available - Enter Address Line 3</label>
...
<div class="col-xl-6">    
    ...
    <div class="form-group">
       <label class="small mb-1" for="office_address_line1">Available - Enter Address Line 1</label>
    ...
    <div class="form-group">
       <label class="small mb-1" for="office_address_line2">Available - Enter Address Line 2</label>
    ...
    <div class="form-group">
       <label class="small mb-1" for="office_address_line3">Available - Enter Address Line 3</label>
    ...
    <div class="form-group">
       <label class="small mb-1" for="office_postal_code">Available - Office Postal Code</label>
    ...
    <div class="form-group">
       <label class="small mb-1" for="office_province">Available - Office Province</label>
...
<div class="row text-center">
    ...
    <div class="col-xl-4"><button class="btn btn-primary btn-bg btn-block text-white" type="submit">Submit Updates</button></div>
    <div class="col-xl-4"> </div>
</div>
